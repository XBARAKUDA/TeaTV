...
function getListFrame(pos){
     ...
     intervalTwo = setInterval(function(){
        if(index == 12){
            ...
            index = index + 1;
            if(document.getElementsByClassName('video-wraper')[0].getElementsByTagName('iframe').length > pos){
                var link = document.getElementsByClassName('video-wraper')[0].getElementsByTagName('iframe')[pos].src;
