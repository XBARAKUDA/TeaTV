...
.method b(I)Z
    ...
    invoke-virtual {p0, p1}, Lit/sephiroth/android/library/widget/ExpandableHListConnector;->i(Lit/sephiroth/android/library/widget/c;)Lit/sephiroth/android/library/widget/ExpandableHListConnector$b;
...
.method c(Lit/sephiroth/android/library/widget/ExpandableHListConnector$b;)Z
    ...
    iget-object v0, p1, Lit/sephiroth/android/library/widget/ExpandableHListConnector$b;->d:Lit/sephiroth/android/library/widget/ExpandableHListConnector$GroupMetadata;
...
.method e(Lit/sephiroth/android/library/widget/ExpandableHListConnector$b;)Z
    ...
    iget v0, v0, Lit/sephiroth/android/library/widget/c;->e:I
    ...
    iget v0, p1, Lit/sephiroth/android/library/widget/ExpandableHListConnector$b;->e:I

    if-le v0, v2, :cond_2

    sub-int/2addr v0, v3

    iput v0, p1, Lit/sephiroth/android/library/widget/ExpandableHListConnector$b;->e:I
    ...
    invoke-static {v2, v2, v0, v4, v5}, Lit/sephiroth/android/library/widget/ExpandableHListConnector$GroupMetadata;->b(IIIJ)Lit/sephiroth/android/library/widget/ExpandableHListConnector$GroupMetadata;

    move-result-object v0

    iget-object v2, p0, Lit/sephiroth/android/library/widget/ExpandableHListConnector;->b:Ljava/util/ArrayList;

    iget p1, p1, Lit/sephiroth/android/library/widget/ExpandableHListConnector$b;->e:I
...
.method public getItem(I)Ljava/lang/Object;
    ...
    iget v1, v0, Lit/sephiroth/android/library/widget/c;->h:I
    ...
    iget v2, v0, Lit/sephiroth/android/library/widget/c;->e:I

    iget v0, v0, Lit/sephiroth/android/library/widget/c;->f:I
...
.method public getItemId(I)J
    ...
    iget v1, v1, Lit/sephiroth/android/library/widget/c;->e:I

    invoke-interface {v0, v1}, Landroid/widget/ExpandableListAdapter;->getGroupId(I)J

    move-result-wide v0

    iget-object v2, p1, Lit/sephiroth/android/library/widget/ExpandableHListConnector$b;->c:Lit/sephiroth/android/library/widget/c;

    iget v3, v2, Lit/sephiroth/android/library/widget/c;->h:I
    ...
    iget v4, v2, Lit/sephiroth/android/library/widget/c;->e:I

    iget v2, v2, Lit/sephiroth/android/library/widget/c;->f:I
...
.method public getItemViewType(I)I
    ...
    iget v2, v0, Lit/sephiroth/android/library/widget/c;->h:I
...
.method public getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    iget v2, v1, Lit/sephiroth/android/library/widget/c;->h:I
    ...
    iget-object v2, v0, Lit/sephiroth/android/library/widget/ExpandableHListConnector$b;->d:Lit/sephiroth/android/library/widget/ExpandableHListConnector$GroupMetadata;
    ...
    iget v5, v1, Lit/sephiroth/android/library/widget/c;->e:I

    iget v6, v1, Lit/sephiroth/android/library/widget/c;->f:I
...
.method i(Lit/sephiroth/android/library/widget/c;)Lit/sephiroth/android/library/widget/ExpandableHListConnector$b;
    .locals 17
    ...
    iget v7, v1, Lit/sephiroth/android/library/widget/c;->e:I

    iget v6, v1, Lit/sephiroth/android/library/widget/c;->h:I

    iget v8, v1, Lit/sephiroth/android/library/widget/c;->f:I
    ...
    iget v13, v1, Lit/sephiroth/android/library/widget/c;->e:I
    ...
    iget v12, v1, Lit/sephiroth/android/library/widget/c;->h:I

    if-ne v12, v6, :cond_4

    iget v11, v15, Lit/sephiroth/android/library/widget/ExpandableHListConnector$GroupMetadata;->b:I

    iget v14, v1, Lit/sephiroth/android/library/widget/c;->f:I
    ...
    :cond_6
    iget v8, v1, Lit/sephiroth/android/library/widget/c;->h:I
    ...
    iget v4, v1, Lit/sephiroth/android/library/widget/c;->e:I

    sub-int/2addr v2, v4

    sub-int v2, v3, v2

    iget v3, v1, Lit/sephiroth/android/library/widget/c;->h:I

    iget v5, v1, Lit/sephiroth/android/library/widget/c;->f:I
