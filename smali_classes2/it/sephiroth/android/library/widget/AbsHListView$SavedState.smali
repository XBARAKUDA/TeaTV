...
.method private constructor <init>(Landroid/os/Parcel;)V
    ...
    invoke-direct {p0, p1}, Lit/sephiroth/android/library/widget/AbsHListView$SavedState;->a(Landroid/os/Parcel;)La/b/j;

    move-result-object v0

    iput-object v0, p0, Lit/sephiroth/android/library/widget/AbsHListView$SavedState;->i:La/b/j;

    invoke-direct {p0, p1}, Lit/sephiroth/android/library/widget/AbsHListView$SavedState;->c(Landroid/os/Parcel;)La/b/f;

    move-result-object p1

    iput-object p1, p0, Lit/sephiroth/android/library/widget/AbsHListView$SavedState;->j:La/b/f;
...
.method private a(Landroid/os/Parcel;)La/b/j;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, v0}, La/b/j;-><init>(I)V

    invoke-direct {p0, v1, p1, v0}, Lit/sephiroth/android/library/widget/AbsHListView$SavedState;->b(La/b/j;Landroid/os/Parcel;I)V

    return-object v1
.end method

.method private b(La/b/j;Landroid/os/Parcel;I)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p1, v0, v1}, La/b/j;->a(ILjava/lang/Object;)V
...
.method private c(Landroid/os/Parcel;)La/b/f;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, v0}, La/b/f;-><init>(I)V

    invoke-direct {p0, v1, p1, v0}, Lit/sephiroth/android/library/widget/AbsHListView$SavedState;->d(La/b/f;Landroid/os/Parcel;I)V

    return-object v1
.end method

.method private d(La/b/f;Landroid/os/Parcel;I)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p1, v0, v1, v2}, La/b/f;->n(JLjava/lang/Object;)V
...
.method private e(La/b/j;Landroid/os/Parcel;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private f(La/b/f;Landroid/os/Parcel;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p1, v0}, La/b/f;->m(I)J

    move-result-wide v2

    invoke-virtual {p2, v2, v3}, Landroid/os/Parcel;->writeLong(J)V

    invoke-virtual {p1, v0}, La/b/f;->w(I)Ljava/lang/Object;
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v1, p0, Lit/sephiroth/android/library/widget/AbsHListView$SavedState;->i:La/b/j;
...
.method public writeToParcel(Landroid/os/Parcel;I)V
    ...
    iget-object p2, p0, Lit/sephiroth/android/library/widget/AbsHListView$SavedState;->i:La/b/j;

    invoke-direct {p0, p2, p1}, Lit/sephiroth/android/library/widget/AbsHListView$SavedState;->e(La/b/j;Landroid/os/Parcel;)V

    iget-object p2, p0, Lit/sephiroth/android/library/widget/AbsHListView$SavedState;->j:La/b/f;

    invoke-direct {p0, p2, p1}, Lit/sephiroth/android/library/widget/AbsHListView$SavedState;->f(La/b/f;Landroid/os/Parcel;)V
