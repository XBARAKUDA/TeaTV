...
# instance fields
.field private final b:Lit/sephiroth/android/library/widget/e;
...
.method constructor <init>(Lit/sephiroth/android/library/widget/AbsHListView;)V
    ...
    iput-object v0, p0, Lit/sephiroth/android/library/widget/AbsHListView$g;->b:Lit/sephiroth/android/library/widget/e;
...
.method static synthetic a(Lit/sephiroth/android/library/widget/AbsHListView$g;)Lit/sephiroth/android/library/widget/e;
    ...
    iget-object p0, p0, Lit/sephiroth/android/library/widget/AbsHListView$g;->b:Lit/sephiroth/android/library/widget/e;
...
.method b(I)V
    ...
    iget-object v0, p0, Lit/sephiroth/android/library/widget/AbsHListView$g;->b:Lit/sephiroth/android/library/widget/e;
    ...
    iget v2, v2, Lit/sephiroth/android/library/widget/AbsHListView;->a4:I

    const/4 v3, 0x0

    invoke-virtual {v0, v1, v3, v2}, Lit/sephiroth/android/library/widget/e;->r(III)V
    ...
    iput v0, p1, Lit/sephiroth/android/library/widget/AbsHListView;->r3:I

    iget-object p1, p1, Lit/sephiroth/android/library/widget/AbsHListView;->w3:Lit/sephiroth/android/library/widget/AbsHListView$l;
    ...
    iput v1, v0, Lit/sephiroth/android/library/widget/AbsHListView;->r3:I

    iget-object v0, p0, Lit/sephiroth/android/library/widget/AbsHListView$g;->b:Lit/sephiroth/android/library/widget/e;

    invoke-virtual {v0}, Lit/sephiroth/android/library/widget/e;->g()F
    ...
    invoke-static {p1}, Lit/sephiroth/android/library/widget/AbsHListView;->x(Lit/sephiroth/android/library/widget/AbsHListView;)Lit/sephiroth/android/library/widget/b;

    move-result-object p1

    invoke-virtual {p1, v0}, Lit/sephiroth/android/library/widget/b;->e(I)V
    ...
    invoke-static {p1}, Lit/sephiroth/android/library/widget/AbsHListView;->y(Lit/sephiroth/android/library/widget/AbsHListView;)Lit/sephiroth/android/library/widget/b;
...
.method e(I)V
    ...
    invoke-virtual {v0, v1}, Lit/sephiroth/android/library/widget/e;->w(Landroid/view/animation/Interpolator;)V

    iget-object v1, p0, Lit/sephiroth/android/library/widget/AbsHListView$g;->b:Lit/sephiroth/android/library/widget/e;
    ...
    invoke-virtual/range {v1 .. v9}, Lit/sephiroth/android/library/widget/e;->d(IIIIIIII)V
...
.method f(I)V
    ...
    iget-object v2, p0, Lit/sephiroth/android/library/widget/AbsHListView$g;->b:Lit/sephiroth/android/library/widget/e;
    ...
    invoke-virtual/range {v2 .. v12}, Lit/sephiroth/android/library/widget/e;->e(IIIIIIIIII)V
...
.method g(IIZ)V
    ...
    sget-object p3, Lit/sephiroth/android/library/widget/AbsHListView;->K2:Landroid/view/animation/Interpolator;
    ...
    :goto_1
    invoke-virtual {v0, p3}, Lit/sephiroth/android/library/widget/e;->w(Landroid/view/animation/Interpolator;)V
    ...
    invoke-virtual/range {v1 .. v6}, Lit/sephiroth/android/library/widget/e;->z(IIIII)V

    iget-object p1, p0, Lit/sephiroth/android/library/widget/AbsHListView$g;->e:Lit/sephiroth/android/library/widget/AbsHListView;

    const/4 p2, 0x4

    iput p2, p1, Lit/sephiroth/android/library/widget/AbsHListView;->r3:I
...
.method h()V
    ...
    invoke-virtual/range {v0 .. v6}, Lit/sephiroth/android/library/widget/e;->x(IIIIII)Z
...
.method public run()V
    ...
    iget v0, v0, Lit/sephiroth/android/library/widget/AbsHListView;->r3:I
    ...
    invoke-virtual {v0}, Lit/sephiroth/android/library/widget/e;->h()I
    ...
    iget v11, v4, Lit/sephiroth/android/library/widget/AbsHListView;->a4:I
    ...
    invoke-virtual {v0}, Lit/sephiroth/android/library/widget/e;->o()Z
    ...
    iget v6, v5, Lit/sephiroth/android/library/widget/a;->j:I

    iput v6, v5, Lit/sephiroth/android/library/widget/AbsHListView;->m3:I
    ...
    iput v5, v6, Lit/sephiroth/android/library/widget/AbsHListView;->n3:I
    ...
    iget v7, v6, Lit/sephiroth/android/library/widget/a;->j:I

    add-int/2addr v7, v5

    iput v7, v6, Lit/sephiroth/android/library/widget/AbsHListView;->m3:I
    ...
    iget v6, v5, Lit/sephiroth/android/library/widget/AbsHListView;->m3:I

    iget v7, v5, Lit/sephiroth/android/library/widget/a;->j:I
    ...
    invoke-virtual {v7, v4, v4}, Lit/sephiroth/android/library/widget/AbsHListView;->Y0(II)Z
    ...
    iget v12, v0, Lit/sephiroth/android/library/widget/AbsHListView;->a4:I
