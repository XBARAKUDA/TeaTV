...
.method public static declared-synchronized a(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_start_2
    invoke-static {p0}, Lb/c/d/z1/i;->c(Ljava/lang/String;)Ljavax/crypto/spec/SecretKeySpec;
    ...
    sget-boolean p0, Lb/c/d/z1/i;->a:Z

    if-nez p0, :cond_2

    const/4 p0, 0x1

    sput-boolean p0, Lb/c/d/z1/i;->a:Z
    ...
    :goto_0
    new-instance p0, Lb/c/c/b;

    const/16 v1, 0x72

    invoke-direct {p0, v1, p1}, Lb/c/c/b;-><init>(ILorg/json/JSONObject;)V

    invoke-static {}, Lb/c/d/p1/g;->v0()Lb/c/d/p1/g;

    move-result-object p1

    invoke-virtual {p1, p0}, Lb/c/d/p1/b;->b(Lb/c/c/b;)V
