...
.method public write(Lorg/xml/sax/ContentHandler;Ljava/lang/Object;)V
    ...
    new-instance v5, Li/a/b/a/b/e$e;

    const/4 v6, 0x0

    const/4 v7, 0x0

    invoke-direct {v5, v0, v6, v7, p1}, Li/a/b/a/b/e$e;-><init>([CILjava/lang/String;Lorg/xml/sax/ContentHandler;)V

    :try_start_0
    new-instance v0, Li/a/b/a/b/e$d;

    invoke-direct {v0, v5}, Li/a/b/a/b/e$d;-><init>(Li/a/b/a/b/e$c;)V
    ...
    :try_end_0
    .catch Li/a/b/a/b/e$f; {:try_start_0 .. :try_end_0} :catch_1
    ...
    invoke-virtual {p1}, Li/a/b/a/b/e$f;->a()Lorg/xml/sax/SAXException;
