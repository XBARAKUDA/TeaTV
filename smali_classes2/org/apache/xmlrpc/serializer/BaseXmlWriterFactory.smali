...
.method public getXmlWriter(Lorg/apache/xmlrpc/common/XmlRpcStreamConfig;Ljava/io/OutputStream;)Lorg/xml/sax/ContentHandler;
    ...
    invoke-virtual {p0}, Lorg/apache/xmlrpc/serializer/BaseXmlWriterFactory;->newXmlWriter()Li/a/b/a/a/g;

    move-result-object v0

    const/4 v1, 0x1

    invoke-interface {v0, v1}, Li/a/b/a/a/g;->g(Z)V
    ...
    :cond_0
    invoke-interface {v0, p1}, Li/a/b/a/a/g;->h(Ljava/lang/String;)V

    const/4 v2, 0x0

    invoke-interface {v0, v2}, Li/a/b/a/a/g;->n(Z)V

    invoke-interface {v0, v1}, Li/a/b/a/a/g;->b(Z)V
    ...
    invoke-interface {v0, v1}, Li/a/b/a/a/g;->a(Ljava/io/Writer;)V
    :try_end_0
...
.method protected newXmlWriter()Li/a/b/a/a/g;
    .locals 1

    new-instance v0, Li/a/b/a/a/h;

    invoke-direct {v0}, Li/a/b/a/a/h;-><init>()V
