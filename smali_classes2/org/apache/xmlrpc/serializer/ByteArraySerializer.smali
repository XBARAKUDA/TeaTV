...
.method public write(Lorg/xml/sax/ContentHandler;Ljava/lang/Object;)V
    ...
    new-instance v4, Li/a/b/a/b/e$e;

    const/4 v5, 0x0

    const/4 v6, 0x0

    invoke-direct {v4, v0, v6, v5, p1}, Li/a/b/a/b/e$e;-><init>([CILjava/lang/String;Lorg/xml/sax/ContentHandler;)V

    :try_start_0
    array-length v0, p2

    invoke-virtual {v4, p2, v6, v0}, Li/a/b/a/b/e$c;->c([BII)V

    invoke-virtual {v4}, Li/a/b/a/b/e$c;->a()V
    :try_end_0
