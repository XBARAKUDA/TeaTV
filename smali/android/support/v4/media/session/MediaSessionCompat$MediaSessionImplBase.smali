...
.field private mVolumeCallback:Landroidx/media/n$b;

.field mVolumeProvider:Landroidx/media/n;
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Landroid/content/ComponentName;Landroid/app/PendingIntent;)V
    ...
    iput-object v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeCallback:Landroidx/media/n$b;
...
.method adjustVolume(II)V
    ...
    iget-object p2, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeProvider:Landroidx/media/n;

    if-eqz p2, :cond_1

    invoke-virtual {p2, p1}, Landroidx/media/n;->e(I)V
...
.method public setPlaybackToLocal(I)V
    ...
    iget-object v0, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeProvider:Landroidx/media/n;

    if-eqz v0, :cond_0

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, Landroidx/media/n;->g(Landroidx/media/n$b;)V
...
.method public setPlaybackToRemote(Landroidx/media/n;)V
    .locals 7
    ...
    iput-object p1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeProvider:Landroidx/media/n;
    ...
    iget-object v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeProvider:Landroidx/media/n;

    invoke-virtual {v1}, Landroidx/media/n;->c()I

    move-result v4

    iget-object v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeProvider:Landroidx/media/n;

    invoke-virtual {v1}, Landroidx/media/n;->b()I

    move-result v5

    iget-object v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeProvider:Landroidx/media/n;

    invoke-virtual {v1}, Landroidx/media/n;->a()I
    ...
    iget-object v0, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeCallback:Landroidx/media/n$b;

    invoke-virtual {p1, v0}, Landroidx/media/n;->g(Landroidx/media/n$b;)V
...
.method setVolumeTo(II)V
    ...
    invoke-virtual {p2, p1}, Landroidx/media/n;->f(I)V
