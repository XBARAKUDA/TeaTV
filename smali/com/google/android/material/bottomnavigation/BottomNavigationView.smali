...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-virtual {v8, v1}, Landroidx/appcompat/view/menu/h;->addMenuPresenter(Landroidx/appcompat/view/menu/p;)V

    invoke-virtual {p0}, Landroid/widget/FrameLayout;->getContext()Landroid/content/Context;

    move-result-object v2

    invoke-virtual {v1, v2, v8}, Lcom/google/android/material/bottomnavigation/BottomNavigationPresenter;->initForMenu(Landroid/content/Context;Landroidx/appcompat/view/menu/h;)V
    ...
    invoke-static/range {v1 .. v6}, Lcom/google/android/material/internal/ThemeEnforcement;->obtainTintedStyledAttributes(Landroid/content/Context;Landroid/util/AttributeSet;[III[I)Landroidx/appcompat/widget/u0;

    move-result-object v1

    sget v2, Lcom/google/android/material/R$styleable;->BottomNavigationView_itemIconTint:I

    invoke-virtual {v1, v2}, Landroidx/appcompat/widget/u0;->B(I)Z

    move-result v3

    if-eqz v3, :cond_0

    invoke-virtual {v1, v2}, Landroidx/appcompat/widget/u0;->d(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v1, v2, v3}, Landroidx/appcompat/widget/u0;->g(II)I

    move-result v2

    invoke-virtual {p0, v2}, Lcom/google/android/material/bottomnavigation/BottomNavigationView;->setItemIconSize(I)V

    invoke-virtual {v1, v12}, Landroidx/appcompat/widget/u0;->B(I)Z

    move-result v2

    if-eqz v2, :cond_1

    invoke-virtual {v1, v12, v13}, Landroidx/appcompat/widget/u0;->u(II)I
    ...
    :cond_1
    invoke-virtual {v1, v14}, Landroidx/appcompat/widget/u0;->B(I)Z

    move-result v2

    if-eqz v2, :cond_2

    invoke-virtual {v1, v14, v13}, Landroidx/appcompat/widget/u0;->u(II)I
    ...
    invoke-static {p0, v2}, Landroidx/core/n/e0;->D1(Landroid/view/View;F)V
    ...
    invoke-virtual {v1, v2, v3}, Landroidx/appcompat/widget/u0;->p(II)I
    ...
    invoke-virtual {v1, v2, v13}, Landroidx/appcompat/widget/u0;->u(II)I
...
.method private addCompatibilityTopDivider(Landroid/content/Context;)V
    ...
    invoke-static {p1, v1}, Landroidx/core/content/b;->e(Landroid/content/Context;I)I
