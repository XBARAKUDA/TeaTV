...
.method addIndicator(Landroid/widget/TextView;I)V
    ...
    new-instance v0, La/h/c/a;

    iget-object v2, p0, Lcom/google/android/material/textfield/IndicatorViewController;->context:Landroid/content/Context;

    invoke-direct {v0, v2}, La/h/c/a;-><init>(Landroid/content/Context;)V
...
.method adjustIndicatorPadding()V
    ...
    invoke-static {v1}, Landroidx/core/n/e0;->g0(Landroid/view/View;)I
    ...
    invoke-static {v2}, Landroidx/core/n/e0;->f0(Landroid/view/View;)I

    move-result v2

    const/4 v3, 0x0

    invoke-static {v0, v1, v3, v2, v3}, Landroidx/core/n/e0;->S1(Landroid/view/View;IIII)V
...
.method setHelperTextEnabled(Z)V
    ...
    invoke-static {v1, v0}, Landroidx/core/n/e0;->t1(Landroid/view/View;I)V
