...
.method public getFont(Landroid/content/Context;)Landroid/graphics/Typeface;
    ...
    invoke-static {p1, v0}, Landroidx/core/content/h/g;->f(Landroid/content/Context;I)Landroid/graphics/Typeface;
...
.method public getFontAsync(Landroid/content/Context;Landroid/text/TextPaint;Landroidx/core/content/h/g$a;)V
    .locals 2
    ...
    invoke-direct {v1, p0, p2, p3}, Lcom/google/android/material/resources/TextAppearance$1;-><init>(Lcom/google/android/material/resources/TextAppearance;Landroid/text/TextPaint;Landroidx/core/content/h/g$a;)V

    const/4 p2, 0x0

    invoke-static {p1, v0, v1, p2}, Landroidx/core/content/h/g;->h(Landroid/content/Context;ILandroidx/core/content/h/g$a;Landroid/os/Handler;)V
    :try_end_0
    .catch Ljava/lang/UnsupportedOperationException; {:try_start_0 .. :try_end_0} :catch_1
    .catch Landroid/content/res/Resources$NotFoundException; {:try_start_0 .. :try_end_0} :catch_1
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public updateDrawState(Landroid/content/Context;Landroid/text/TextPaint;Landroidx/core/content/h/g$a;)V
    .locals 4

    invoke-virtual {p0, p1, p2, p3}, Lcom/google/android/material/resources/TextAppearance;->updateMeasureState(Landroid/content/Context;Landroid/text/TextPaint;Landroidx/core/content/h/g$a;)V
...
.method public updateMeasureState(Landroid/content/Context;Landroid/text/TextPaint;Landroidx/core/content/h/g$a;)V
    .locals 1
    .param p3    # Landroidx/core/content/h/g$a;
        .annotation build Landroidx/annotation/k0;
        .end annotation
    ...
    :cond_0
    invoke-virtual {p0, p1, p2, p3}, Lcom/google/android/material/resources/TextAppearance;->getFontAsync(Landroid/content/Context;Landroid/text/TextPaint;Landroidx/core/content/h/g$a;)V
