...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = La/k/a;->r(Landroid/print/PrintAttributes;ILandroid/graphics/Bitmap;Landroid/os/ParcelFileDescriptor;Landroid/os/CancellationSignal;Landroid/print/PrintDocumentAdapter$WriteResultCallback;)V
.end annotation
...
.field final synthetic h:La/k/a;


# direct methods
.method constructor <init>(La/k/a;Landroid/os/CancellationSignal;Landroid/print/PrintAttributes;Landroid/graphics/Bitmap;Landroid/print/PrintAttributes;ILandroid/os/ParcelFileDescriptor;Landroid/print/PrintDocumentAdapter$WriteResultCallback;)V
    .locals 0

    iput-object p1, p0, La/k/a$a;->h:La/k/a;

    iput-object p2, p0, La/k/a$a;->a:Landroid/os/CancellationSignal;

    iput-object p3, p0, La/k/a$a;->b:Landroid/print/PrintAttributes;

    iput-object p4, p0, La/k/a$a;->c:Landroid/graphics/Bitmap;

    iput-object p5, p0, La/k/a$a;->d:Landroid/print/PrintAttributes;

    iput p6, p0, La/k/a$a;->e:I

    iput-object p7, p0, La/k/a$a;->f:Landroid/os/ParcelFileDescriptor;

    iput-object p8, p0, La/k/a$a;->g:Landroid/print/PrintDocumentAdapter$WriteResultCallback;
...
.method protected varargs a([Ljava/lang/Void;)Ljava/lang/Throwable;
    ...
    :try_start_0
    iget-object p1, p0, La/k/a$a;->a:Landroid/os/CancellationSignal;
    ...
    iget-object v1, p0, La/k/a$a;->h:La/k/a;

    iget-object v1, v1, La/k/a;->k:Landroid/content/Context;

    iget-object v2, p0, La/k/a$a;->b:Landroid/print/PrintAttributes;
    ...
    iget-object v1, p0, La/k/a$a;->c:Landroid/graphics/Bitmap;
    ...
    invoke-static {v1, v2}, La/k/a;->a(Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;

    move-result-object v1

    iget-object v2, p0, La/k/a$a;->a:Landroid/os/CancellationSignal;
    ...
    iget-object v6, p0, La/k/a$a;->h:La/k/a;

    iget-object v6, v6, La/k/a;->k:Landroid/content/Context;

    iget-object v7, p0, La/k/a$a;->d:Landroid/print/PrintAttributes;
    ...
    iget v7, p0, La/k/a$a;->e:I

    invoke-static {v5, v6, v2, v7}, La/k/a;->d(IILandroid/graphics/RectF;I)Landroid/graphics/Matrix;
    ...
    iget-object p1, p0, La/k/a$a;->f:Landroid/os/ParcelFileDescriptor;
    :try_end_2
    ...
    :cond_4
    :try_start_4
    iget-object p1, p0, La/k/a$a;->c:Landroid/graphics/Bitmap;
    ...
    iget-object v3, p0, La/k/a$a;->f:Landroid/os/ParcelFileDescriptor;
...
.method protected b(Ljava/lang/Throwable;)V
    ...
    iget-object v0, p0, La/k/a$a;->a:Landroid/os/CancellationSignal;
    ...
    iget-object p1, p0, La/k/a$a;->g:Landroid/print/PrintDocumentAdapter$WriteResultCallback;
...
.method protected bridge synthetic doInBackground([Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, La/k/a$a;->a([Ljava/lang/Void;)Ljava/lang/Throwable;
...
.method protected bridge synthetic onPostExecute(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, La/k/a$a;->b(Ljava/lang/Throwable;)V
