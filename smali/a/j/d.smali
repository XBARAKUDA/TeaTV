...
.field private final S1:Ljava/io/File;

.field private final T1:Ljava/io/RandomAccessFile;

.field private final U1:Ljava/nio/channels/FileChannel;

.field private final V1:Ljava/nio/channels/FileLock;
...
.method constructor <init>(Ljava/io/File;Ljava/io/File;)V
    ...
    iput-object p1, p0, La/j/d;->Q1:Ljava/io/File;

    iput-object p2, p0, La/j/d;->S1:Ljava/io/File;

    invoke-static {p1}, La/j/d;->i(Ljava/io/File;)J

    move-result-wide v2

    iput-wide v2, p0, La/j/d;->R1:J
    ...
    iput-object p2, p0, La/j/d;->T1:Ljava/io/RandomAccessFile;
    ...
    iput-object p2, p0, La/j/d;->U1:Ljava/nio/channels/FileChannel;
    :try_end_0
    ...
    iput-object p2, p0, La/j/d;->V1:Ljava/nio/channels/FileLock;
    :try_end_1
    ...
    :goto_0
    iget-object p2, p0, La/j/d;->U1:Ljava/nio/channels/FileChannel;

    invoke-static {p2}, La/j/d;->c(Ljava/io/Closeable;)V
    ...
    :goto_1
    iget-object p2, p0, La/j/d;->T1:Ljava/io/RandomAccessFile;
...
.method private b()V
    ...
    iget-object v0, p0, La/j/d;->S1:Ljava/io/File;

    new-instance v1, La/j/d$a;

    invoke-direct {v1, p0}, La/j/d$a;-><init>(La/j/d;)V
    ...
    iget-object v2, p0, La/j/d;->S1:Ljava/io/File;
...
.method private static d(Ljava/util/zip/ZipFile;Ljava/util/zip/ZipEntry;Ljava/io/File;Ljava/lang/String;)V
    ...
    invoke-static {p0}, La/j/d;->c(Ljava/io/Closeable;)V
...
.method private static i(Ljava/io/File;)J
    ...
    invoke-static {p0}, La/j/f;->c(Ljava/io/File;)J
...
.method private static j(Landroid/content/Context;Ljava/io/File;JLjava/lang/String;)Z
    ...
    invoke-static {p0}, La/j/d;->f(Landroid/content/Context;)Landroid/content/SharedPreferences;
    ...
    invoke-static {p1}, La/j/d;->g(Ljava/io/File;)J
...
.method private l(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
    ...
    iget-object v3, v0, La/j/d;->Q1:Ljava/io/File;
    ...
    invoke-static/range {p1 .. p1}, La/j/d;->f(Landroid/content/Context;)Landroid/content/SharedPreferences;
    ...
    new-instance v8, La/j/d$b;

    iget-object v9, v0, La/j/d;->S1:Ljava/io/File;

    invoke-direct {v8, v9, v7}, La/j/d$b;-><init>(Ljava/io/File;Ljava/lang/String;)V
    ...
    invoke-static {v8}, La/j/d;->i(Ljava/io/File;)J

    move-result-wide v9

    iput-wide v9, v8, La/j/d$b;->a:J
...
.method private m()Ljava/util/List;
    ...
    iget-object v6, v1, La/j/d;->Q1:Ljava/io/File;
    ...
    invoke-direct/range {p0 .. p0}, La/j/d;->b()V
    ...
    iget-object v0, v1, La/j/d;->Q1:Ljava/io/File;
    ...
    new-instance v11, La/j/d$b;

    iget-object v12, v1, La/j/d;->S1:Ljava/io/File;

    invoke-direct {v11, v12, v0}, La/j/d$b;-><init>(Ljava/io/File;Ljava/lang/String;)V
    ...
    invoke-static {v8, v10, v11, v6}, La/j/d;->d(Ljava/util/zip/ZipFile;Ljava/util/zip/ZipEntry;Ljava/io/File;Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    :try_start_1
    invoke-static {v11}, La/j/d;->i(Ljava/io/File;)J

    move-result-wide v14

    iput-wide v14, v11, La/j/d$b;->a:J
    :try_end_1
    ...
    iget-wide v12, v11, La/j/d$b;->a:J
...
.method public close()V
    ...
    iget-object v0, p0, La/j/d;->V1:Ljava/nio/channels/FileLock;

    invoke-virtual {v0}, Ljava/nio/channels/FileLock;->release()V

    iget-object v0, p0, La/j/d;->U1:Ljava/nio/channels/FileChannel;

    invoke-virtual {v0}, Ljava/nio/channels/FileChannel;->close()V

    iget-object v0, p0, La/j/d;->T1:Ljava/io/RandomAccessFile;
...
.method k(Landroid/content/Context;Ljava/lang/String;Z)Ljava/util/List;
    ...
    iget-object v1, p0, La/j/d;->Q1:Ljava/io/File;
    ...
    iget-object v0, p0, La/j/d;->Q1:Ljava/io/File;

    iget-wide v2, p0, La/j/d;->R1:J

    invoke-static {p1, v0, v2, v3, p2}, La/j/d;->j(Landroid/content/Context;Ljava/io/File;JLjava/lang/String;)Z
    ...
    :try_start_0
    invoke-direct {p0, p1, p2}, La/j/d;->l(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-direct {p0}, La/j/d;->m()Ljava/util/List;

    move-result-object p3

    iget-object v0, p0, La/j/d;->Q1:Ljava/io/File;

    invoke-static {v0}, La/j/d;->g(Ljava/io/File;)J

    move-result-wide v4

    iget-wide v6, p0, La/j/d;->R1:J
    ...
    invoke-static/range {v2 .. v8}, La/j/d;->n(Landroid/content/Context;Ljava/lang/String;JJLjava/util/List;)V
