...
.method private s(Landroid/widget/RemoteViews;Z)Landroid/widget/RemoteViews;
    ...
    invoke-static {v3}, Landroidx/core/app/o$i;->u(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-direct {p0, v5}, Landroidx/core/app/o$i;->t(Landroidx/core/app/o$b;)Landroid/widget/RemoteViews;
    ...
    invoke-virtual {p0, v0, p1}, Landroidx/core/app/o$p;->e(Landroid/widget/RemoteViews;Landroid/widget/RemoteViews;)V

    return-object v0
.end method

.method private t(Landroidx/core/app/o$b;)Landroid/widget/RemoteViews;
    .locals 6

    iget-object v0, p1, Landroidx/core/app/o$b;->x:Landroid/app/PendingIntent;
    ...
    iget-object v4, v4, Landroidx/core/app/o$g;->b:Landroid/content/Context;
    ...
    invoke-virtual {p0, v3, v4}, Landroidx/core/app/o$p;->j(Landroidx/core/graphics/drawable/IconCompat;I)Landroid/graphics/Bitmap;
    ...
    iget-object v3, p1, Landroidx/core/app/o$b;->w:Ljava/lang/CharSequence;
    ...
    iget-object v2, p1, Landroidx/core/app/o$b;->x:Landroid/app/PendingIntent;
    ...
    iget-object p1, p1, Landroidx/core/app/o$b;->w:Ljava/lang/CharSequence;
...
.method public n(Landroidx/core/app/n;)Landroid/widget/RemoteViews;
    ...
    invoke-virtual {p1}, Landroidx/core/app/o$g;->l()Landroid/widget/RemoteViews;
    ...
    invoke-direct {p0, p1, v0}, Landroidx/core/app/o$i;->s(Landroid/widget/RemoteViews;Z)Landroid/widget/RemoteViews;
...
.method public p(Landroidx/core/app/n;)Landroid/widget/RemoteViews;
    ...
    invoke-virtual {p1}, Landroidx/core/app/o$g;->n()Landroid/widget/RemoteViews;
    ...
    invoke-direct {p0, v1, p1}, Landroidx/core/app/o$i;->s(Landroid/widget/RemoteViews;Z)Landroid/widget/RemoteViews;
