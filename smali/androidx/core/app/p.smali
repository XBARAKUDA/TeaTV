...
.method constructor <init>(Landroidx/core/app/o$g;)V
    ...
    iget-object v3, p1, Landroidx/core/app/o$g;->b:Landroid/content/Context;

    iget-object v4, p1, Landroidx/core/app/o$g;->K:Ljava/lang/String;

    invoke-direct {v2, v3, v4}, Landroid/app/Notification$Builder;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    iput-object v2, p0, Landroidx/core/app/p;->a:Landroid/app/Notification$Builder;
    ...
    :goto_0
    iget-object v2, p1, Landroidx/core/app/o$g;->R:Landroid/app/Notification;
    ...
    iget-object v5, p1, Landroidx/core/app/o$g;->i:Landroid/widget/RemoteViews;
    ...
    iget-object v4, p1, Landroidx/core/app/o$g;->e:Ljava/lang/CharSequence;

    invoke-virtual {v3, v4}, Landroid/app/Notification$Builder;->setContentTitle(Ljava/lang/CharSequence;)Landroid/app/Notification$Builder;

    move-result-object v3

    iget-object v4, p1, Landroidx/core/app/o$g;->f:Ljava/lang/CharSequence;

    invoke-virtual {v3, v4}, Landroid/app/Notification$Builder;->setContentText(Ljava/lang/CharSequence;)Landroid/app/Notification$Builder;

    move-result-object v3

    iget-object v4, p1, Landroidx/core/app/o$g;->k:Ljava/lang/CharSequence;

    invoke-virtual {v3, v4}, Landroid/app/Notification$Builder;->setContentInfo(Ljava/lang/CharSequence;)Landroid/app/Notification$Builder;

    move-result-object v3

    iget-object v4, p1, Landroidx/core/app/o$g;->g:Landroid/app/PendingIntent;
    ...
    iget-object v4, p1, Landroidx/core/app/o$g;->h:Landroid/app/PendingIntent;
    ...
    iget-object v4, p1, Landroidx/core/app/o$g;->j:Landroid/graphics/Bitmap;
    ...
    iget v4, p1, Landroidx/core/app/o$g;->l:I

    invoke-virtual {v3, v4}, Landroid/app/Notification$Builder;->setNumber(I)Landroid/app/Notification$Builder;

    move-result-object v3

    iget v4, p1, Landroidx/core/app/o$g;->t:I

    iget v8, p1, Landroidx/core/app/o$g;->u:I

    iget-boolean v9, p1, Landroidx/core/app/o$g;->v:Z
    ...
    iget-object v4, p0, Landroidx/core/app/p;->a:Landroid/app/Notification$Builder;
    ...
    iget-object v7, p1, Landroidx/core/app/o$g;->r:Ljava/lang/CharSequence;
    ...
    invoke-direct {p0, v7}, Landroidx/core/app/p;->b(Landroidx/core/app/o$b;)V

    goto :goto_5

    :cond_6
    iget-object v0, p1, Landroidx/core/app/o$g;->D:Landroid/os/Bundle;

    if-eqz v0, :cond_7

    iget-object v7, p0, Landroidx/core/app/p;->f:Landroid/os/Bundle;
    ...
    iget-boolean v0, p1, Landroidx/core/app/o$g;->z:Z
    ...
    :cond_8
    iget-object v0, p1, Landroidx/core/app/o$g;->w:Ljava/lang/String;
    ...
    iget-boolean v0, p1, Landroidx/core/app/o$g;->x:Z
    ...
    :cond_a
    :goto_6
    iget-object v0, p1, Landroidx/core/app/o$g;->y:Ljava/lang/String;

    if-eqz v0, :cond_b

    iget-object v5, p0, Landroidx/core/app/p;->f:Landroid/os/Bundle;
    ...
    iput-object v0, p0, Landroidx/core/app/p;->c:Landroid/widget/RemoteViews;

    iget-object v0, p1, Landroidx/core/app/o$g;->I:Landroid/widget/RemoteViews;

    iput-object v0, p0, Landroidx/core/app/p;->d:Landroid/widget/RemoteViews;
    ...
    iget-object v5, p0, Landroidx/core/app/p;->a:Landroid/app/Notification$Builder;

    iget-boolean v7, p1, Landroidx/core/app/o$g;->n:Z

    invoke-virtual {v5, v7}, Landroid/app/Notification$Builder;->setShowWhen(Z)Landroid/app/Notification$Builder;

    if-ge v0, v3, :cond_d

    iget-object v5, p1, Landroidx/core/app/o$g;->S:Ljava/util/ArrayList;
    ...
    iget-object v7, p1, Landroidx/core/app/o$g;->S:Ljava/util/ArrayList;
    ...
    iget-object v3, p1, Landroidx/core/app/o$g;->C:Ljava/lang/String;
    ...
    iget v3, p1, Landroidx/core/app/o$g;->F:I

    invoke-virtual {v0, v3}, Landroid/app/Notification$Builder;->setVisibility(I)Landroid/app/Notification$Builder;

    move-result-object v0

    iget-object v3, p1, Landroidx/core/app/o$g;->G:Landroid/app/Notification;
    ...
    iget-object v0, p1, Landroidx/core/app/o$g;->S:Ljava/util/ArrayList;
    ...
    :cond_f
    iget-object v0, p1, Landroidx/core/app/o$g;->J:Landroid/widget/RemoteViews;

    iput-object v0, p0, Landroidx/core/app/p;->h:Landroid/widget/RemoteViews;

    iget-object v0, p1, Landroidx/core/app/o$g;->d:Ljava/util/ArrayList;
    ...
    :goto_8
    iget-object v5, p1, Landroidx/core/app/o$g;->d:Ljava/util/ArrayList;
    ...
    iget-object v7, p1, Landroidx/core/app/o$g;->d:Ljava/util/ArrayList;
    ...
    invoke-static {v7}, Landroidx/core/app/r;->j(Landroidx/core/app/o$b;)Landroid/os/Bundle;
    ...
    iget-object v3, p1, Landroidx/core/app/o$g;->D:Landroid/os/Bundle;

    invoke-virtual {v2, v3}, Landroid/app/Notification$Builder;->setExtras(Landroid/os/Bundle;)Landroid/app/Notification$Builder;

    move-result-object v2

    iget-object v3, p1, Landroidx/core/app/o$g;->s:[Ljava/lang/CharSequence;
    ...
    :cond_13
    iget-object v2, p1, Landroidx/core/app/o$g;->I:Landroid/widget/RemoteViews;
    ...
    :cond_14
    iget-object v2, p1, Landroidx/core/app/o$g;->J:Landroid/widget/RemoteViews;
    ...
    iget-boolean v1, p1, Landroidx/core/app/o$g;->P:Z
    ...
    iget-object p1, p1, Landroidx/core/app/o$g;->Q:Landroidx/core/app/o$f;

    invoke-static {p1}, Landroidx/core/app/o$f;->j(Landroidx/core/app/o$f;)Landroid/app/Notification$BubbleMetadata;
...
.method private b(Landroidx/core/app/o$b;)V
    .locals 5
    ...
    invoke-static {v0}, Landroidx/core/app/v;->d([Landroidx/core/app/v;)[Landroid/app/RemoteInput;
    ...
    invoke-static {v1, p1}, Landroidx/core/app/r;->o(Landroid/app/Notification$Builder;Landroidx/core/app/o$b;)Landroid/os/Bundle;
...
.method public c()Landroid/app/Notification;
    ...
    iget-object v0, v0, Landroidx/core/app/o$g;->q:Landroidx/core/app/o$p;

    if-eqz v0, :cond_0

    invoke-virtual {v0, p0}, Landroidx/core/app/o$p;->b(Landroidx/core/app/n;)V

    :cond_0
    if-eqz v0, :cond_1

    invoke-virtual {v0, p0}, Landroidx/core/app/o$p;->o(Landroidx/core/app/n;)Landroid/widget/RemoteViews;
    ...
    :goto_0
    invoke-virtual {p0}, Landroidx/core/app/p;->d()Landroid/app/Notification;
    ...
    iget-object v1, v1, Landroidx/core/app/o$g;->H:Landroid/widget/RemoteViews;
    ...
    invoke-virtual {v0, p0}, Landroidx/core/app/o$p;->n(Landroidx/core/app/n;)Landroid/widget/RemoteViews;
    ...
    iget-object v4, p0, Landroidx/core/app/p;->b:Landroidx/core/app/o$g;

    iget-object v4, v4, Landroidx/core/app/o$g;->q:Landroidx/core/app/o$p;

    invoke-virtual {v4, p0}, Landroidx/core/app/o$p;->p(Landroidx/core/app/n;)Landroid/widget/RemoteViews;
    ...
    invoke-static {v2}, Landroidx/core/app/o;->j(Landroid/app/Notification;)Landroid/os/Bundle;
...
.method protected d()Landroid/app/Notification;
    ...
    invoke-direct {p0, v0}, Landroidx/core/app/p;->e(Landroid/app/Notification;)V
    ...
    invoke-static {v0}, Landroidx/core/app/o;->j(Landroid/app/Notification;)Landroid/os/Bundle;
