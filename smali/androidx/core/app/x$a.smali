...
.method private i(Ljava/lang/String;[Ljava/lang/String;)V
    ...
    invoke-virtual {p0}, Landroidx/core/app/x$a;->n()Landroid/content/Intent;
...
.method public static k(Landroid/app/Activity;)Landroidx/core/app/x$a;
    .locals 1
    ...
    invoke-static {v0, p0}, Landroidx/core/app/x$a;->l(Landroid/content/Context;Landroid/content/ComponentName;)Landroidx/core/app/x$a;
...
.method private static l(Landroid/content/Context;Landroid/content/ComponentName;)Landroidx/core/app/x$a;
    .locals 1
...
.method public b([Ljava/lang/String;)Landroidx/core/app/x$a;
    ...
    invoke-direct {p0, v0, p1}, Landroidx/core/app/x$a;->i(Ljava/lang/String;[Ljava/lang/String;)V
...
.method public g(Landroid/net/Uri;)Landroidx/core/app/x$a;
    .locals 3
    ...
    invoke-virtual {p0, p1}, Landroidx/core/app/x$a;->u(Landroid/net/Uri;)Landroidx/core/app/x$a;
...
.method public n()Landroid/content/Intent;
    ...
    invoke-direct {p0, v2, v0}, Landroidx/core/app/x$a;->h(Ljava/lang/String;Ljava/util/ArrayList;)V
...
.method public o(I)Landroidx/core/app/x$a;
    .locals 1
    .param p1    # I
    ...
    invoke-virtual {p0, p1}, Landroidx/core/app/x$a;->p(Ljava/lang/CharSequence;)Landroidx/core/app/x$a;
...
.method public p(Ljava/lang/CharSequence;)Landroidx/core/app/x$a;
    .locals 0
...
.method public q([Ljava/lang/String;)Landroidx/core/app/x$a;
    .locals 2
    .param p1    # [Ljava/lang/String;
        .annotation build Landroidx/annotation/k0;
        .end annotation
...
.method public r([Ljava/lang/String;)Landroidx/core/app/x$a;
    .locals 2
    .param p1    # [Ljava/lang/String;
        .annotation build Landroidx/annotation/k0;
        .end annotation
...
.method public s([Ljava/lang/String;)Landroidx/core/app/x$a;
    .locals 2
    .param p1    # [Ljava/lang/String;
        .annotation build Landroidx/annotation/k0;
        .end annotation
...
.method public t(Ljava/lang/String;)Landroidx/core/app/x$a;
    .locals 2
    .param p1    # Ljava/lang/String;
        .annotation build Landroidx/annotation/k0;
        .end annotation
    ...
    invoke-virtual {p0, p1}, Landroidx/core/app/x$a;->w(Ljava/lang/CharSequence;)Landroidx/core/app/x$a;

    :cond_0
    return-object p0
.end method

.method public u(Landroid/net/Uri;)Landroidx/core/app/x$a;
    .locals 2
    .param p1    # Landroid/net/Uri;
        .annotation build Landroidx/annotation/k0;
        .end annotation
...
.method public v(Ljava/lang/String;)Landroidx/core/app/x$a;
    .locals 2
    .param p1    # Ljava/lang/String;
        .annotation build Landroidx/annotation/k0;
        .end annotation
...
.method public w(Ljava/lang/CharSequence;)Landroidx/core/app/x$a;
    .locals 2
    .param p1    # Ljava/lang/CharSequence;
        .annotation build Landroidx/annotation/k0;
        .end annotation
...
.method public x(Ljava/lang/String;)Landroidx/core/app/x$a;
    .locals 1
    .param p1    # Ljava/lang/String;
        .annotation build Landroidx/annotation/k0;
        .end annotation
...
.method public y()V
    ...
    invoke-virtual {p0}, Landroidx/core/app/x$a;->j()Landroid/content/Intent;
