...
.method private static a(Landroid/animation/LayoutTransition;)V
    ...
    sget-boolean v0, Landroidx/transition/s0;->g:Z
    ...
    sput-object v4, Landroidx/transition/s0;->f:Ljava/lang/reflect/Method;
    ...
    :goto_0
    sput-boolean v0, Landroidx/transition/s0;->g:Z

    :cond_0
    sget-object v0, Landroidx/transition/s0;->f:Ljava/lang/reflect/Method;
...
.method static b(Landroid/view/ViewGroup;Z)V
    ...
    sget-object v0, Landroidx/transition/s0;->c:Landroid/animation/LayoutTransition;
    ...
    invoke-direct {v0}, Landroidx/transition/s0$a;-><init>()V

    sput-object v0, Landroidx/transition/s0;->c:Landroid/animation/LayoutTransition;
    ...
    invoke-static {p1}, Landroidx/transition/s0;->a(Landroid/animation/LayoutTransition;)V
    ...
    :cond_2
    sget-object p1, Landroidx/transition/s0;->c:Landroid/animation/LayoutTransition;
    ...
    sget-boolean p1, Landroidx/transition/s0;->e:Z
    ...
    sput-object p1, Landroidx/transition/s0;->d:Ljava/lang/reflect/Field;
    ...
    :goto_0
    sput-boolean v1, Landroidx/transition/s0;->e:Z

    :cond_4
    sget-object p1, Landroidx/transition/s0;->d:Ljava/lang/reflect/Field;
    ...
    :try_start_2
    sget-object v1, Landroidx/transition/s0;->d:Ljava/lang/reflect/Field;
