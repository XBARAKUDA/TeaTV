...
.field private Y1:Landroidx/appcompat/widget/ActionBarOverlayLayout$d;

.field private Z1:Landroid/widget/OverScroller;

.field a2:Landroid/view/ViewPropertyAnimator;

.field final b2:Landroid/animation/AnimatorListenerAdapter;
...
.field private final e2:Landroidx/core/n/w;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->S1:Landroid/graphics/Rect;

    new-instance p2, Landroid/graphics/Rect;

    invoke-direct {p2}, Landroid/graphics/Rect;-><init>()V

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->T1:Landroid/graphics/Rect;
    ...
    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->b2:Landroid/animation/AnimatorListenerAdapter;

    new-instance p2, Landroidx/appcompat/widget/ActionBarOverlayLayout$b;

    invoke-direct {p2, p0}, Landroidx/appcompat/widget/ActionBarOverlayLayout$b;-><init>(Landroidx/appcompat/widget/ActionBarOverlayLayout;)V

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->c2:Ljava/lang/Runnable;

    new-instance p2, Landroidx/appcompat/widget/ActionBarOverlayLayout$c;

    invoke-direct {p2, p0}, Landroidx/appcompat/widget/ActionBarOverlayLayout$c;-><init>(Landroidx/appcompat/widget/ActionBarOverlayLayout;)V

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->d2:Ljava/lang/Runnable;
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->e2:Landroidx/core/n/w;
...
.method private A()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->c2:Ljava/lang/Runnable;
...
.method private B(FF)Z
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->Z1:Landroid/widget/OverScroller;
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->Z1:Landroid/widget/OverScroller;
...
.method private a()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->d2:Ljava/lang/Runnable;
...
.method private f(Landroid/view/View;Landroid/graphics/Rect;ZZZZ)Z
    .locals 2
...
.method private s(Landroid/view/View;)Landroidx/appcompat/widget/z;
    .locals 3
...
.method private u(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->Z1:Landroid/widget/OverScroller;
...
.method public b(Landroid/view/Menu;Landroidx/appcompat/view/menu/p$a;)V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->h:Landroidx/appcompat/widget/z;

    invoke-interface {v0, p1, p2}, Landroidx/appcompat/widget/z;->b(Landroid/view/Menu;Landroidx/appcompat/view/menu/p$a;)V
...
.method protected fitSystemWindows(Landroid/graphics/Rect;)Z
    ...
    invoke-static {p0}, Landroidx/core/n/e0;->v0(Landroid/view/View;)I
    ...
    invoke-direct/range {v1 .. v7}, Landroidx/appcompat/widget/ActionBarOverlayLayout;->f(Landroid/view/View;Landroid/graphics/Rect;ZZZZ)Z

    move-result v0

    iget-object v1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->U1:Landroid/graphics/Rect;

    invoke-virtual {v1, p1}, Landroid/graphics/Rect;->set(Landroid/graphics/Rect;)V

    iget-object p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->U1:Landroid/graphics/Rect;

    iget-object v1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->R1:Landroid/graphics/Rect;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->U1:Landroid/graphics/Rect;
    ...
    :cond_0
    iget-object p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->S1:Landroid/graphics/Rect;

    iget-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->R1:Landroid/graphics/Rect;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->R1:Landroid/graphics/Rect;
...
.method public getNestedScrollAxes()I
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->e2:Landroidx/core/n/w;
...
.method public m(Landroid/util/SparseArray;)V
    ...
    invoke-interface {v0, p1}, Landroidx/appcompat/widget/z;->w(Landroid/util/SparseArray;)V
...
.method public n(I)V
    ...
    :cond_1
    iget-object p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->h:Landroidx/appcompat/widget/z;
...
.method protected onMeasure(II)V
    ...
    :cond_3
    :goto_1
    iget-object v6, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->T1:Landroid/graphics/Rect;

    iget-object v7, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->R1:Landroid/graphics/Rect;

    invoke-virtual {v6, v7}, Landroid/graphics/Rect;->set(Landroid/graphics/Rect;)V

    iget-object v6, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->W1:Landroid/graphics/Rect;

    iget-object v7, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->U1:Landroid/graphics/Rect;
    ...
    iget-object v4, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->T1:Landroid/graphics/Rect;
    ...
    :cond_4
    iget-object v4, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->W1:Landroid/graphics/Rect;
    ...
    iget-object v8, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->T1:Landroid/graphics/Rect;
    ...
    invoke-direct/range {v6 .. v12}, Landroidx/appcompat/widget/ActionBarOverlayLayout;->f(Landroid/view/View;Landroid/graphics/Rect;ZZZZ)Z
...
.method public onNestedFling(Landroid/view/View;FFZ)Z
    ...
    iget-boolean p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->N1:Z
...
.method public onNestedScroll(Landroid/view/View;IIII)V
    ...
    iget p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->P1:I

    add-int/2addr p1, p3

    iput p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->P1:I
...
.method public onNestedScrollAccepted(Landroid/view/View;Landroid/view/View;I)V
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->Y1:Landroidx/appcompat/widget/ActionBarOverlayLayout$d;
...
.method public onStopNestedScroll(Landroid/view/View;)V
    ...
    iget-boolean p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->O1:Z
...
.method public onWindowSystemUiVisibilityChanged(I)V
    ...
    iget v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->Q1:I

    xor-int/2addr v0, p1

    iput p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->Q1:I
...
.method protected onWindowVisibilityChanged(I)V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->Y1:Landroidx/appcompat/widget/ActionBarOverlayLayout$d;
...
.method public p(Landroid/util/SparseArray;)V
    ...
    invoke-interface {v0, p1}, Landroidx/appcompat/widget/z;->J(Landroid/util/SparseArray;)V
...
.method public setActionBarVisibilityCallback(Landroidx/appcompat/widget/ActionBarOverlayLayout$d;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->Y1:Landroidx/appcompat/widget/ActionBarOverlayLayout$d;
    ...
    iget p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->Q1:I
...
.method t()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->a2:Landroid/view/ViewPropertyAnimator;
...
.method z()V
    ...
    invoke-direct {p0, v0}, Landroidx/appcompat/widget/ActionBarOverlayLayout;->s(Landroid/view/View;)Landroidx/appcompat/widget/z;

    move-result-object v0

    iput-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->h:Landroidx/appcompat/widget/z;
