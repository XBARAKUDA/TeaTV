...
.field final synthetic h:Landroidx/mediarouter/app/f;
...
.method constructor <init>(Landroidx/mediarouter/app/f;)V
    ...
    iput-object p1, p0, Landroidx/mediarouter/app/f$d;->h:Landroidx/mediarouter/app/f;

    invoke-direct {p0}, Landroidx/recyclerview/widget/RecyclerView$g;-><init>()V

    iget-object v0, p1, Landroidx/mediarouter/app/f;->h:Landroid/content/Context;

    invoke-static {v0}, Landroid/view/LayoutInflater;->from(Landroid/content/Context;)Landroid/view/LayoutInflater;

    move-result-object v0

    iput-object v0, p0, Landroidx/mediarouter/app/f$d;->c:Landroid/view/LayoutInflater;
    ...
    iget-object p1, p1, Landroidx/mediarouter/app/f;->h:Landroid/content/Context;

    invoke-static {p1}, Landroidx/mediarouter/app/j;->k(Landroid/content/Context;)Landroid/graphics/drawable/Drawable;

    move-result-object p1

    iput-object p1, p0, Landroidx/mediarouter/app/f$d;->g:Landroid/graphics/drawable/Drawable;

    invoke-virtual {p0}, Landroidx/mediarouter/app/f$d;->e()V
...
.method c(Landroidx/mediarouter/a/k$g;)Landroid/graphics/drawable/Drawable;
    ...
    :try_start_0
    iget-object v1, p0, Landroidx/mediarouter/app/f$d;->h:Landroidx/mediarouter/app/f;

    iget-object v1, v1, Landroidx/mediarouter/app/f;->h:Landroid/content/Context;
    ...
    :cond_0
    invoke-direct {p0, p1}, Landroidx/mediarouter/app/f$d;->b(Landroidx/mediarouter/a/k$g;)Landroid/graphics/drawable/Drawable;
...
.method public d(I)Landroidx/mediarouter/app/f$d$b;
    .locals 1

    iget-object v0, p0, Landroidx/mediarouter/app/f$d;->b:Ljava/util/ArrayList;
...
.method e()V
    ...
    iput-object v0, p0, Landroidx/mediarouter/app/f$d;->b:Ljava/util/ArrayList;
    ...
    iget-object v1, v1, Landroidx/mediarouter/app/f;->j:Ljava/util/List;
    ...
    iget-object v2, p0, Landroidx/mediarouter/app/f$d;->h:Landroidx/mediarouter/app/f;

    iget-object v2, v2, Landroidx/mediarouter/app/f;->j:Ljava/util/List;
    ...
    instance-of v3, v2, Landroidx/mediarouter/a/k$f;
    ...
    :cond_1
    iget-object v1, p0, Landroidx/mediarouter/app/f$d;->b:Ljava/util/ArrayList;

    new-instance v2, Landroidx/mediarouter/app/f$d$b;

    iget-object v3, p0, Landroidx/mediarouter/app/f$d;->h:Landroidx/mediarouter/app/f;

    iget-object v3, v3, Landroidx/mediarouter/app/f;->h:Landroid/content/Context;
    ...
    iget-object v3, p0, Landroidx/mediarouter/app/f$d;->b:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, Landroidx/mediarouter/app/f$d;->b:Ljava/util/ArrayList;
...
.method public onBindViewHolder(Landroidx/recyclerview/widget/RecyclerView$e0;I)V
    ...
    invoke-virtual {p0, p2}, Landroidx/mediarouter/app/f$d;->d(I)Landroidx/mediarouter/app/f$d$b;
...
.method public onCreateViewHolder(Landroid/view/ViewGroup;I)Landroidx/recyclerview/widget/RecyclerView$e0;
    ...
    :cond_0
    iget-object p2, p0, Landroidx/mediarouter/app/f$d;->c:Landroid/view/LayoutInflater;
