...
.field private g:Landroidx/legacy/app/FragmentTabHost$b;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1, v0}, Landroidx/legacy/app/FragmentTabHost;->e(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {p0, p1, p2}, Landroidx/legacy/app/FragmentTabHost;->e(Landroid/content/Context;Landroid/util/AttributeSet;)V

    return-void
.end method

.method private b(Ljava/lang/String;Landroid/app/FragmentTransaction;)Landroid/app/FragmentTransaction;
    .locals 4
    ...
    iget-object p1, p0, Landroidx/legacy/app/FragmentTabHost;->g:Landroidx/legacy/app/FragmentTabHost$b;
    ...
    :goto_1
    iput-object v0, p0, Landroidx/legacy/app/FragmentTabHost;->g:Landroidx/legacy/app/FragmentTabHost$b;
...
.method public a(Landroid/widget/TabHost$TabSpec;Ljava/lang/Class;Landroid/os/Bundle;)V
    ...
    iget-object v1, p0, Landroidx/legacy/app/FragmentTabHost;->c:Landroid/content/Context;
    ...
    invoke-direct {v1, v0, p2, p3}, Landroidx/legacy/app/FragmentTabHost$b;-><init>(Ljava/lang/String;Ljava/lang/Class;Landroid/os/Bundle;)V

    iget-boolean p2, p0, Landroidx/legacy/app/FragmentTabHost;->h:Z

    if-eqz p2, :cond_0

    iget-object p2, p0, Landroidx/legacy/app/FragmentTabHost;->d:Landroid/app/FragmentManager;
...
.method public f(Landroid/content/Context;Landroid/app/FragmentManager;)V
    .locals 0
    .annotation runtime Ljava/lang/Deprecated;
    .end annotation

    invoke-direct {p0, p1}, Landroidx/legacy/app/FragmentTabHost;->d(Landroid/content/Context;)V
    ...
    invoke-direct {p0}, Landroidx/legacy/app/FragmentTabHost;->c()V

    return-void
.end method

.method public g(Landroid/content/Context;Landroid/app/FragmentManager;I)V
    .locals 0
    .annotation runtime Ljava/lang/Deprecated;
    .end annotation
...
.method protected onAttachedToWindow()V
    ...
    iput-object v3, p0, Landroidx/legacy/app/FragmentTabHost;->g:Landroidx/legacy/app/FragmentTabHost$b;
    ...
    invoke-direct {p0, v0, v1}, Landroidx/legacy/app/FragmentTabHost;->b(Ljava/lang/String;Landroid/app/FragmentTransaction;)Landroid/app/FragmentTransaction;
...
.method public onTabChanged(Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, v0}, Landroidx/legacy/app/FragmentTabHost;->b(Ljava/lang/String;Landroid/app/FragmentTransaction;)Landroid/app/FragmentTransaction;
