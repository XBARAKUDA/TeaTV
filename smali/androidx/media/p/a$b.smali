.class public Landroidx/media/p/a$b;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroidx/media/p/a$b;->g:[I
...
.method public constructor <init>(Landroidx/core/app/o$g;)V
    ...
    invoke-virtual {p0, p1}, Landroidx/core/app/o$p;->r(Landroidx/core/app/o$g;)V

    return-void
.end method

.method private v(Landroidx/core/app/o$b;)Landroid/widget/RemoteViews;
    .locals 4
...
.method public static y(Landroid/app/Notification;)Landroid/support/v4/media/session/MediaSessionCompat$Token;
    .locals 3
...
# virtual methods
.method public A(Landroid/support/v4/media/session/MediaSessionCompat$Token;)Landroidx/media/p/a$b;
    .locals 0

    iput-object p1, p0, Landroidx/media/p/a$b;->h:Landroid/support/v4/media/session/MediaSessionCompat$Token;

    return-object p0
.end method

.method public varargs B([I)Landroidx/media/p/a$b;
    .locals 0

    iput-object p1, p0, Landroidx/media/p/a$b;->g:[I

    return-object p0
.end method

.method public C(Z)Landroidx/media/p/a$b;
    .locals 2
    ...
    iput-boolean p1, p0, Landroidx/media/p/a$b;->i:Z
...
.method public b(Landroidx/core/app/n;)V
    ...
    :cond_0
    iget-boolean v0, p0, Landroidx/media/p/a$b;->i:Z
...
.method s(Landroid/app/Notification$MediaStyle;)Landroid/app/Notification$MediaStyle;
    .locals 1
    .annotation build Landroidx/annotation/o0;
        value = 0x15
    .end annotation

    iget-object v0, p0, Landroidx/media/p/a$b;->g:[I
    ...
    :cond_0
    iget-object v0, p0, Landroidx/media/p/a$b;->h:Landroid/support/v4/media/session/MediaSessionCompat$Token;
...
.method t()Landroid/widget/RemoteViews;
    .locals 6

    iget-object v0, p0, Landroidx/core/app/o$p;->a:Landroidx/core/app/o$g;

    iget-object v0, v0, Landroidx/core/app/o$g;->c:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v0}, Landroidx/media/p/a$b;->w(I)I

    move-result v1

    const/4 v2, 0x0

    invoke-virtual {p0, v2, v1, v2}, Landroidx/core/app/o$p;->c(ZIZ)Landroid/widget/RemoteViews;
    ...
    iget-object v4, v4, Landroidx/core/app/o$g;->c:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v4}, Landroidx/media/p/a$b;->v(Landroidx/core/app/o$b;)Landroid/widget/RemoteViews;
    ...
    iget-object v2, p0, Landroidx/media/p/a$b;->j:Landroid/app/PendingIntent;
...
.method u()Landroid/widget/RemoteViews;
    .locals 8

    invoke-virtual {p0}, Landroidx/media/p/a$b;->x()I
    ...
    invoke-virtual {p0, v1, v0, v2}, Landroidx/core/app/o$p;->c(ZIZ)Landroid/widget/RemoteViews;

    move-result-object v0

    iget-object v3, p0, Landroidx/core/app/o$p;->a:Landroidx/core/app/o$g;

    iget-object v3, v3, Landroidx/core/app/o$g;->c:Ljava/util/ArrayList;

    invoke-virtual {v3}, Ljava/util/ArrayList;->size()I

    move-result v3

    iget-object v4, p0, Landroidx/media/p/a$b;->g:[I
    ...
    iget-object v6, v6, Landroidx/core/app/o$g;->c:Ljava/util/ArrayList;

    iget-object v7, p0, Landroidx/media/p/a$b;->g:[I
    ...
    invoke-direct {p0, v6}, Landroidx/media/p/a$b;->v(Landroidx/core/app/o$b;)Landroid/widget/RemoteViews;
    ...
    :cond_2
    iget-boolean v2, p0, Landroidx/media/p/a$b;->i:Z
    ...
    iget-object v1, p0, Landroidx/media/p/a$b;->j:Landroid/app/PendingIntent;
...
.method public z(Landroid/app/PendingIntent;)Landroidx/media/p/a$b;
    .locals 0

    iput-object p1, p0, Landroidx/media/p/a$b;->j:Landroid/app/PendingIntent;
