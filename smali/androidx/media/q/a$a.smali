...
.method constructor <init>(Landroid/content/Context;Landroid/content/Intent;Landroid/content/BroadcastReceiver$PendingResult;)V
    ...
    iput-object p1, p0, Landroidx/media/q/a$a;->a:Landroid/content/Context;

    iput-object p2, p0, Landroidx/media/q/a$a;->b:Landroid/content/Intent;

    iput-object p3, p0, Landroidx/media/q/a$a;->c:Landroid/content/BroadcastReceiver$PendingResult;
...
.method private a()V
    ...
    iget-object v0, p0, Landroidx/media/q/a$a;->d:Landroid/support/v4/media/MediaBrowserCompat;

    invoke-virtual {v0}, Landroid/support/v4/media/MediaBrowserCompat;->disconnect()V

    iget-object v0, p0, Landroidx/media/q/a$a;->c:Landroid/content/BroadcastReceiver$PendingResult;
...
.method b(Landroid/support/v4/media/MediaBrowserCompat;)V
    ...
    iput-object p1, p0, Landroidx/media/q/a$a;->d:Landroid/support/v4/media/MediaBrowserCompat;
...
.method public onConnected()V
    ...
    iget-object v1, p0, Landroidx/media/q/a$a;->a:Landroid/content/Context;

    iget-object v2, p0, Landroidx/media/q/a$a;->d:Landroid/support/v4/media/MediaBrowserCompat;
    ...
    iget-object v1, p0, Landroidx/media/q/a$a;->b:Landroid/content/Intent;
    ...
    :goto_0
    invoke-direct {p0}, Landroidx/media/q/a$a;->a()V
