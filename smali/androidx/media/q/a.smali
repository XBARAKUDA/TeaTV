...
.method public static a(Landroid/content/Context;J)Landroid/app/PendingIntent;
    ...
    invoke-static {p0}, Landroidx/media/q/a;->c(Landroid/content/Context;)Landroid/content/ComponentName;
    ...
    :cond_0
    invoke-static {p0, v0, p1, p2}, Landroidx/media/q/a;->b(Landroid/content/Context;Landroid/content/ComponentName;J)Landroid/app/PendingIntent;
...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    :cond_0
    invoke-static {p1, v1}, Landroidx/media/q/a;->d(Landroid/content/Context;Ljava/lang/String;)Landroid/content/ComponentName;
    ...
    invoke-static {p1, p2}, Landroidx/media/q/a;->f(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-static {p1, v0}, Landroidx/media/q/a;->d(Landroid/content/Context;Ljava/lang/String;)Landroid/content/ComponentName;
    ...
    new-instance v2, Landroidx/media/q/a$a;

    invoke-direct {v2, p1, p2, v1}, Landroidx/media/q/a$a;-><init>(Landroid/content/Context;Landroid/content/Intent;Landroid/content/BroadcastReceiver$PendingResult;)V
    ...
    invoke-virtual {v2, p2}, Landroidx/media/q/a$a;->b(Landroid/support/v4/media/MediaBrowserCompat;)V
